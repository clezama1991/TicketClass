...
Route::group(
    ...
    Route::group(['middleware' => ['auth', 'first.run']], function () {
        ...
        Route::group(['prefix' => 'organiser'], function () {
            ...
            Route::get('{organiser_id}/maps', [
                'as'   => 'showOrganiserMaps',
                'uses' => 'MapsController@showCustomize',
            ]);

            Route::post('create_maps', [
                'as'   => 'CreateOrganiserMaps',
                'uses' => 'MapsController@postCreateMaps',
            ]);

            Route::post('edit_maps', [
                'as'   => 'EditOrganiserMaps',
                'uses' => 'MapsController@editCreateMaps',
            ]);

            Route::get('{map_id}/maps/cancel', [
                'as'   => 'showCancelMaps',
                'uses' => 'MapsController@showCancelAttendee',
            ]);

            Route::post('cancel_maps', [
                'as'   => 'CancelOrganiserMaps',
                'uses' => 'MapsController@CancelOrganiserMaps',
            ]);

            Route::get('{organiser_id}/maps/{map_id}/sections', [
                'uses' => 'MapsController@showSections',
            ]);

            Route::post('create_maps_section', [
                'as'   => 'CreateOrganiserMapsSection',
                'uses' => 'MapsController@postCreateMapsSection',
            ]);

            Route::post('edit_maps_section', [
                'as'   => 'EditOrganiserMapsSection',
                'uses' => 'MapsController@editCreateMapsSection',
            ]);

            Route::get('{map_id}/maps_section/cancel', [
                'as'   => 'showCancelMapsSection',
                'uses' => 'MapsController@showCancelSection',
            ]);

            Route::post('cancel_maps_section', [
                'as'   => 'CancelOrganiserMapsSection',
                'uses' => 'MapsController@CancelOrganiserMapsSection',
            ]);
        ...
        Route::group(['prefix' => 'event'], function () {
            ...
            Route::post('tickets/avert', [
                'as'   => 'postAvertSeat',
                'uses' => 'EventTicketsController@postAvertSeat',
            ]);

            Route::post('{ticket_id}/tickets/sale', [
                'as'   => 'postSalesTickets',
                'uses' => 'EventTicketsController@postSalesTickets',
            ]);

            Route::get('{ticket_id}/{price}/tickets/sale', [
                'as'   => 'newSalesTickets',
                'uses' => 'EventTicketsController@newSalesTickets',
            ]);
            ...
            Route::get('{event_id}/attendeess/invite', [
