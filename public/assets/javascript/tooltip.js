...
(function ($) {
	...
	$('#hall-seat-plan').mapster({
		...
		areas: [{
			...
			{
			key: "A1",
				toolTip: $('<br><br><p>Sección <strong>A1</strong></p><span>Comprar</span>')
				
			},
			{
			key: "A2",
				toolTip: $('<br><p>Sección <strong>A2</strong></p><span>Comprar</span>'),
			},
			{
			key: "A3",
				toolTip: $('<br><p>Sección <strong>A3</strong></p><span>Comprar</span>'),
			},
			{
			key: "A4",
				toolTip: $('<br><p>Sección <strong>A4</strong></p><span>Comprar</span>'),
			},
			{
			key: "A5",
				toolTip: $('<br><p>Sección <strong>A5</strong></p><span>Comprar</span>'),
			},
			{
			key: "A6",
				toolTip: $('<br><p>Sección <strong>A6</strong></p><span>Comprar</span>'),
			},
			{
			key: "B1",
				toolTip: $('<br><p>Sección <strong>B1</strong></p><span>Comprar</span>'),
			},
			{
			key: "B2",
				toolTip: $('<br><p>Sección <strong>B2</strong></p><span>Comprar</span>'),
			},
			{
			key: "B3",
				toolTip: $('<br><p>Sección <strong>B3</strong></p><span>Comprar</span>'),
			},
			{
			key: "B4",
				toolTip: $('<br><p>Sección <strong>B4</strong></p><span>Comprar</span>'),
			},
			{
			key: "B5",
				toolTip: $('<br><p>Sección <strong>B5</strong></p><span>Comprar</span>'),
			},
			{
			key: "B6",
				toolTip: $('<br><p>Sección <strong>B6</strong></p><span>Comprar</span>'),
			},
			{
			key: "C1",
				toolTip: $('<br><p>Sección <strong>C1</strong></p><span>Comprar</span>'),
			},
			{
			key: "C2",
				toolTip: $('<br><p>Sección <strong>C2</strong></p><span>Comprar</span>'),
			},
			{
			key: "C3",
				toolTip: $('<br><p>Sección <strong>C3</strong></p><span>Comprar</span>'),
			},
			{
			key: "C4",
				toolTip: $('<br><p>Sección <strong>C4</strong></p><span>Comprar</span>'),
			},
			{
			key: "C5",
				toolTip: $('<br><p>Sección <strong>C5</strong></p><span>Comprar</span>'),
			},
			{
			key: "C6",
				toolTip: $('<br><p>Sección <strong>C6</strong></p><span>Comprar</span>'),
		}]
	});
