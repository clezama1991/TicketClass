                ...
                <div class="flex-container-wrap">
                    <div class="flexizq66a100compra" style="vertical-align:top;">
                        ...
                        <script type="module"> 
                            ...
                            var workspaceKey = '{{$event->map_id}}';
                            console.log('workspaceKey',workspaceKey,event);
         
                            var selectedSeats = [];
        
                            let client = new seatsio.SeatingChart({
                                    divId: 'chart',
                                    workspaceKey: 'b82c25c5-cc8e-4c50-8efc-f81171ee987b',
                                    event: event,
                                    session: 'continue',
                                ...
                                onObjectSelected: function (object) {
                                    ...
                                    $('#tickets_seats').val(selectedSeats);
                            ...
                            // await client.events.changeObjectStatus('8dda854c-37de-4157-9aca-e5fb3234e11c', selectedSeats, 'sold');
                        ...
                        <ul class="nav nav-tabs d-none" id="myTab" role="tablist">
                            <li class="nav-item w-50 show-boleto" role="presentation">
                                <button class="nav-link active w-100" id="home-tab" data-bs-toggle="tab"
                                    ...
                                    aria-selected="true">Busqueda de Boletos</button>
                            </li>
                            <li class="nav-item w-50 show-mapa" role="presentation">
                                <button class="nav-link w-100" id="profile-tab" data-bs-toggle="tab"
                                    data-bs-target="#profile" type="button" role="tab" aria-controls="profile"
                                    aria-selected="false">Selecciona tus Asientos</button>
                            </li>
                        </ul>

                        <div id="contenedor_principal d-none">
                            ...
                            <div class="ancho_100"
                                    ...
                                    <div class="tab-pane active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        <div style="padding-top:20px">
                                            ...
                                            <div id="divSecciones" style="">
                                                ...
                                                @foreach ($tickets_all as $keygrup => $item)
                                                    ...
                                                    <div class="seccion contenedor select-zona d-block"
                                                        id="grupo{{ $grupo_zona }}" data-zonaid="{{ $name_grup }}"
                                                        data-zonaname="{{ $keygrup }}" style="display: block;">
                                            ...
                                            <div id="divHeaderSeccion" class="headerpaso IdDivZonasT d-none">Selecciona tu
                                                SECCION&nbsp;<span id="spSeccionSeleccionado"
                                                    class="headerseleccion"></span>
                                            </div>
                                                    ...
                                                    @foreach ($tickets_all as $key_tickets_all => $ticket_all)
                                                        ...
                                                        @foreach ($ticket_all as $sectkey => $sect)
                                                            ...
                                                            <div class="seccion contenedor select-section d-none {{ $name_grup }}"
                                                                ...
                                                                <div class="seccion agotado" style="display: none;">AGOTADO
                                                                </div>
                                                            </div>
                                                        @endforeach
                                                    @endforeach
                                ...
                                <div id="divPrecios" class="card mt-5" style="">
                                    ...
                                    <input type="hidden" id="tickets_seats" name="tickets_seats">
                                    ...
                                    @foreach ($event->tickets as $vite)
                                        ...
                                        <input type="hidden" name="ticket_{{ $vite->id }}" value="0"
                                            class="ticketx_{{ $vite->id }}">
                                        ...
                                        @foreach ($ticket_all as $sectkey => $sect)
                                            ...
                                            @foreach ($sect as $ticketskey => $tickets_scr)
                                                @foreach ($tickets_scr as $ticketkey => $ticket)
                                                    ...
                                                    <div class="d-none zone-events zone-event-{{ $ticket_seat_zone }}"
                                                        id="{{ $ticket->id }}">

                                                        <div class="card-header">
                                                            <h5 class="card-title">
                                                                @if ($ticket->select_seat == 1)
                                                                    Selecciona los asientos del bloque:
                                                                    {{ $ticket->title }}
                                                                @else
                                                                    Selecciona la cantidad de boletos del bloque:
                                                                    {{ $ticket->title }}
                                                                @endif
                                                            </h5>
                                                        </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="row d-flex justify-content-end mb-5">
                                                                        <div class="col-12 d-flex justify-content-end">
                                                                            <a data-ticketid="{{ $ticket->id }}"
                                                                                class="btn btn-primary zoom-out"
                                                                                style="margin-right: 5px;">
                                                                                <!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
                                                                                <svg fill="#ffffff" width="20px"
                                                                    ...
                                                                    <div class="row m-1 mapa{{ $ticket->id }}">
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div class="tb ancho_100">
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        class="input-group input-group-sm bootstrap-touchspin">
                                                                                                        <span
                                                                        ...
                                                                        @foreach ($ticket_seats as $key_file => $seats)
                                                                            <div class="col-md-12 mb-4">
                                                                                <span style='  white-space: break-word;'>
                                                                                    Fila {{ $abecedario[$key_file - 1] }}
                                                                                    <span>
