                        ...
                        <div class="panel-footer" style="height: 56px;">
                            <div class="row">
                                    <div class="sortHandle col-md-2" title="@lang("basic.drag_to_reorder")">
                                        ...
                                        <div class="col-md-3">
                                            <button data-modal-id="newSaleTicket" data-href="{{route('newSalesTickets', ['ticket_id'=>$ticket->id, 'price'=>$ticket->price])}}" type="button"  class="btn btn-block btn-success loadModal"><i class="ico-shopping-cart"></i></button>
                                        </div>
