                            ...
                            <div class=" ">
                                <div class="row">
                                    <div id="" class="col-md-12" style="display: flex;justify-content: center;">
                                        <img id="hall-seat-plan"
                                            src="{{ asset('assets/images/select_seat/stage-bg.jpg') }}" alt="stage"
                                            usemap="#map" />
                                        <map name="map" class="seatmap">
                                            ...
                                            <area data-seat="{{ in_array($key,$zonas_disponibles) ? 'sold' : " x".$key
                                                }}" data-seatzone="{{ $key}}" class="selected_zone" alt="{{ $key }}"
                                                href="#" shape="poly" coords="{{$coord}}">
                                            @endforeach
