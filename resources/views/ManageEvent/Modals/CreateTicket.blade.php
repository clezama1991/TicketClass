                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    {!! Form::label('title', trans("ManageEvent.ticket_section"), array('class'=>'control-label required')) !!}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                        <div class="form-group asientos hide">
                                            {!! Form::label('asientos_blanco', 'Asientos en Blanco', array('class'=>' control-label ')) !!}
