...
return [
    ...
    'default_timezone'           => 11, #Europe/Dublin
    ...
    'default_locale'             => 'en',
    'default_payment_gateway'    => 2, #Stripe=1 Paypal=2
